...
export class MortgageController {
    ...
    @Get('calculations')
        async getAllCalcRecords(@Query() query: GetCalculationsQueryDto): Promise<MortgageRecordResultDto[]>
    ...
    @Get('calculations/:id')
        async getOneCalcRecord(@Param('id', ParseIntPipe) id: number): Promise<MortgageRecordResultDto>
    ...
    @Delete('calculations/:id')
        async deleteOneCalcRecord(@Param('id', ParseIntPipe) id: number): Promise<void>
